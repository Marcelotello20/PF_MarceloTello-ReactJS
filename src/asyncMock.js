//LISTA DE PRODUCTOS
const products = [
    {id: 1, category: 'Produccion', name: 'Produccion Completa Promo Apollo Full', price: 155000, stock: 2 , description: 'Descripcion producto' , img: '../public/images/productos/1 promo-apollo-full.png'},
    {id: 2, category: 'Produccion', name: 'Produccion Completa Promo Apollo', price: 145000, stock: 4 , description: 'Descripcion producto' , img: '../public/images/productos/2 promo-apollo.png'},
    {id: 3, category: 'Produccion', name: 'Produccion Completa Promo Akai', price: 125000, stock: 2 , description: 'Descripcion producto' , img: '../public/images/productos/3 promo-akai.png'},
